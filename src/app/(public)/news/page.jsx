              ...
              <div className="bg-navy-deep p-12 lg:p-20 flex flex-col justify-between text-white space-y-12">
                <div>
                  ...
                  <Link
                    ...
                    className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center text-white hover:bg-white hover:text-navy-deep transition-all duration-300 group"
                  >
