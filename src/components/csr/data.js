export const heroSlides = [
    { url: "/csr/Header 1.webp", alt: "Corporate Social Responsibility" },
    { url: "/csr/Header 2.webp", alt: "Gesit Foundation Activities" },
    { url: "/csr/Header 3.webp", alt: "Healthcare Initiatives" }
];
