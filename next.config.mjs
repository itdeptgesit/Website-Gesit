        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://challenges.cloudflare.com https://dev.gesit.co.id; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https://bbntlrtozsdqvelsxlhz.supabase.co https://res.cloudinary.com https://dev.gesit.co.id https://gesit.co.id https://blogger.googleusercontent.com https://*.googleusercontent.com https://upload.wikimedia.org; font-src 'self' data: https://fonts.gstatic.com https://dev.gesit.co.id; connect-src 'self' https://bbntlrtozsdqvelsxlhz.supabase.co https://challenges.cloudflare.com https://dev.gesit.co.id; frame-src 'self' https://www.youtube.com https://challenges.cloudflare.com; media-src 'self' https://bbntlrtozsdqvelsxlhz.supabase.co https://dev.gesit.co.id https://gesit.co.id;",
          },
          {
